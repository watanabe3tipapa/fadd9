...
(() => {
  ...
  const staticItems = [
    ...
    { group: "PAGE", label: "Tutorial — ABC記法チュートリアル", hint: "学習 入門 ステップ", href: BASE + "tutorial/index.html" },
    { group: "PAGE", label: "Reference — ABC記法チートシート", hint: "文法 早見表 記号", href: BASE + "reference/index.html" },
    { group: "PAGE", label: "Standard — ABC記法標準 v2.2", hint: "公式 仕様 詳細", href: BASE + "standard/index.html" },
    { group: "PAGE", label: "Worksheets — 採譜ワークシート", hint: "印刷 テンプレート 採譜", href: BASE + "worksheets/index.html" },
